...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/proyectouniverdad.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/proyectouniverdad.exe: ${OBJECTFILES}
...
${OBJECTDIR}/InterfazControl.o: InterfazControl.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InterfazControl.o InterfazControl.cpp
